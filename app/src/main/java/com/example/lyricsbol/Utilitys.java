...
import com.example.lyricsbol.fragments.DetailsFrag;
...
public class Utilitys {
    ...
    public static void removeTempOnFailure(Context con, long downloadId) {
    ...
    public static void mergeMp4(String inFilePathAudio, String inFilePathVideo) {
    ...
    private static void writeMetaData(Container out, String artist, String title) {
        MovieBox mBox = null;
    ...
    private static void correctChunkOffsets(Container container, long correction) {
    ...
    public static DetailsFrag.DownloadStatus getMultiFileDlStatus(Context con, long downloadId, String filePath) {
        File cacheFileDir = new File(con.getCacheDir().getAbsolutePath());
        File cacheFile = null;
        for (File f : cacheFileDir.listFiles()) {
            if (f.getName().contains(downloadId + "")) {
        ...
        if (cacheFile != null && cacheFile.exists()) {
            DetailsFrag.DownloadStatus dlStatus = new DetailsFrag.DownloadStatus();
